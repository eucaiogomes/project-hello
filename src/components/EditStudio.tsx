      ...
      <div className="mt-2 flex items-center gap-2 px-4 flex-wrap">
        ...
        <button
          onClick={() => {
            ...
            setMarkerIn(inT);
            setMarkerOut(outT);
            toast.success("Ajuste os marcadores e clique em Cortar região");
          }}
          className="flex items-center gap-1.5 rounded-md bg-primary px-2.5 py-1.5 text-xs font-medium text-primary-foreground transition-all hover:bg-primary/90"
          title="Cortar trecho — ajuste os marcadores IN/OUT"
        >
        ...
        {hasMarkerRegion && (
          <>
            ...
            <button onClick={deleteMarkerRegion} className="flex items-center gap-1.5 rounded-md bg-destructive px-2.5 py-1.5 text-xs font-medium text-destructive-foreground transition-all hover:bg-destructive/90">
              <Trash2 className="h-3.5 w-3.5" /> Cortar região
            </button>
